    ...
    constructor(data) {
        ...
        if (isTetMesh) {
            ...
            for (let i = 0, numKeys = keys.length; i < numKeys; i++) {
                ...
                const orientation = _MSHMesh._dotProduct(_MSHMesh._crossProduct(_MSHMesh._vecFromTo(a, b, nodesArray), _MSHMesh._vecFromTo(a, c, nodesArray)), _MSHMesh._vecFromTo(a, d, nodesArray));
